                    ...
                    <div id={props?.type_carousel} className="owl-carousel wow fadeIn">
                        {
                            ...
                            [1, 2, 3, 4, 5, 6,].map((x) => { return (<Product is_none_name={true} name={`Unisex look is the best ${x}`} price={180.000} img={`images/mau_ao/ao_don/aodon-${x}.jpg`} type={User.Customer} />) })
                        }
