export const SectionPopular = () => {
    return (<section id="section-popular" className="pb-5">
                ...
                <div className="col-md-12 wow fadeIn">
                    <ol className="author_list">
                        ...
                        <li>
                            ...
                            <div className="author_list_info">
                                <a href="04_retro-author.html">Mamie Barnett</a>
                                <span>2.8 ETH</span>
                            </div>
                        </li>
                        <li>
                            ...
                            <div className="author_list_info">
                                <a href="04_retro-author.html">Nicholas Daniels</a>
                                <span>2.5 ETH</span>
                            </div>
                        </li>
                        <li>
                            ...
                            <div className="author_list_info">
                                <a href="04_retro-author.html">Lori Hart</a>
                                <span>2.2 ETH</span>
                            </div>
                        </li>
                        <li>
                            ...
                            <div className="author_list_info">
                                <a href="04_retro-author.html">Jimmy Wright</a>
                                <span>1.9 ETH</span>
                            </div>
                        </li>
                        <li>
                            ...
                            <div className="author_list_info">
                                <a href="04_retro-author.html">Karla Sharp</a>
                                <span>1.6 ETH</span>
                            </div>
                        </li>
                        <li>
                            ...
                            <div className="author_list_info">
                                <a href="04_retro-author.html">Gayle Hicks</a>
                                <span>1.5 ETH</span>
                            </div>
                        </li>
                        <li>
                            ...
                            <div className="author_list_info">
                                <a href="04_retro-author.html">Claude Banks</a>
                                <span>1.3 ETH</span>
                            </div>
                        </li>
                        <li>
                            ...
                            <div className="author_list_info">
                                <a href="04_retro-author.html">Franklin Greer</a>
                                <span>0.9 ETH</span>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div className="author_list_info">
                                <a href="04_retro-author.html">Ida Chapman</a>
                                <span>0.6 ETH</span>
                            </div>
                        </li>
                        <li>
                            ...
                            <div className="author_list_info">
                                <a href="04_retro-author.html">Fred Ryan</a>
                                <span>0.5 eth</span>
                            </div>
                        </li>
                    </ol>
